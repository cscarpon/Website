...
The final output has a band which resembles the distance from river layer. This would bring into question the accuracy of the lead layer (kriging would probably be a more appropriate usage here). 